...
import { getTrackPlan } from "../graphql/queries";
import { updateTrackPlan } from "../graphql/mutations";
const client = generateClient();
export default function TrackPlanUpdateForm(props) {
  const {
    id: idProp,
    trackPlan: trackPlanModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = trackPlanRecord
      ? { ...initialValues, ...trackPlanRecord }
      : initialValues;
    setUserId(cleanValues.userId);
    setCompletedDate(cleanValues.CompletedDate);
    setCompletedTime(cleanValues.CompletedTime);
    setActionDomain(cleanValues.ActionDomain);
    setActionQuestion(cleanValues.ActionQuestion);
    setAction(cleanValues.Action);
    setFrequency(cleanValues.Frequency);
    setActionNote(cleanValues.ActionNote);
    setUpdate1Points(cleanValues.Update1Points);
    setUpdate1Note(cleanValues.Update1Note);
    setUpdate1Date(cleanValues.Update1Date);
    setUpdate2Points(cleanValues.Update2Points);
    setUpdate2Note(cleanValues.Update2Note);
    setUpdate2Date(cleanValues.Update2Date);
    setUpdate3Points(cleanValues.Update3Points);
    setUpdate3Note(cleanValues.Update3Note);
    setUpdate3Date(cleanValues.Update3Date);
    setUpdate4Points(cleanValues.Update4Points);
    setUpdate4Note(cleanValues.Update4Note);
    setUpdate4Date(cleanValues.Update4Date);
    setUpdate5Points(cleanValues.Update5Points);
    setUpdate5Note(cleanValues.Update5Note);
    setUpdate5Date(cleanValues.Update5Date);
    setUpdate6Points(cleanValues.Update6Points);
    setUpdate6Note(cleanValues.Update6Note);
    setUpdate6Date(cleanValues.Update6Date);
    setUpdate7Points(cleanValues.Update7Points);
    setUpdate7Note(cleanValues.Update7Note);
    setUpdate7Date(cleanValues.Update7Date);
    setUpdate8Points(cleanValues.Update8Points);
    setUpdate8Note(cleanValues.Update8Note);
    setUpdate8Date(cleanValues.Update8Date);
    setPercentage(cleanValues.Percentage);
    setDiscontinued(cleanValues.Discontinued);
    setDiscontinuedDate(cleanValues.DiscontinuedDate);
    setSuccessful(cleanValues.Successful);
    setSuccessfulDate(cleanValues.SuccessfulDate);
    setErrors({});
  };
  const [trackPlanRecord, setTrackPlanRecord] =
    React.useState(trackPlanModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getTrackPlan.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getTrackPlan
        : trackPlanModelProp;
      setTrackPlanRecord(record);
    };
    queryData();
  }, [idProp, trackPlanModelProp]);
  React.useEffect(resetStateValues, [trackPlanRecord]);
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          ActionQuestion: ActionQuestion ?? null,
          Action: Action ?? null,
          Frequency: Frequency ?? null,
          ActionNote: ActionNote ?? null,
          Update1Points: Update1Points ?? null,
          Update1Note: Update1Note ?? null,
          Update1Date: Update1Date ?? null,
          Update2Points: Update2Points ?? null,
          Update2Note: Update2Note ?? null,
          Update2Date: Update2Date ?? null,
          Update3Points: Update3Points ?? null,
          Update3Note: Update3Note ?? null,
          Update3Date: Update3Date ?? null,
          Update4Points: Update4Points ?? null,
          Update4Note: Update4Note ?? null,
          Update4Date: Update4Date ?? null,
          Update5Points: Update5Points ?? null,
          Update5Note: Update5Note ?? null,
          Update5Date: Update5Date ?? null,
          Update6Points: Update6Points ?? null,
          Update6Note: Update6Note ?? null,
          Update6Date: Update6Date ?? null,
          Update7Points: Update7Points ?? null,
          Update7Note: Update7Note ?? null,
          Update7Date: Update7Date ?? null,
          Update8Points: Update8Points ?? null,
          Update8Note: Update8Note ?? null,
          Update8Date: Update8Date ?? null,
          Percentage: Percentage ?? null,
          Discontinued: Discontinued ?? null,
          DiscontinuedDate: DiscontinuedDate ?? null,
          Successful: Successful ?? null,
          SuccessfulDate: SuccessfulDate ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateTrackPlan.replaceAll("__typename", ""),
            variables: {
              input: {
                id: trackPlanRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "TrackPlanUpdateForm")}
      {...rest}
    >
      <TextField
        label="User id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || trackPlanModelProp)}
