...
export declare type OrganizationInformationCreateFormInputValues = {
    userId?: string;
    BusinessName?: string;
    BusinessEIN?: number;
...
export declare type OrganizationInformationCreateFormValidationValues = {
...
export declare type OrganizationInformationCreateFormOverridesProps = {
    OrganizationInformationCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type OrganizationInformationCreateFormProps = React.PropsWithChildren<{
    overrides?: OrganizationInformationCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: OrganizationInformationCreateFormInputValues) => OrganizationInformationCreateFormInputValues;
    onSuccess?: (fields: OrganizationInformationCreateFormInputValues) => void;
    onError?: (fields: OrganizationInformationCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: OrganizationInformationCreateFormInputValues) => OrganizationInformationCreateFormInputValues;
    onValidate?: OrganizationInformationCreateFormValidationValues;
} & React.CSSProperties>;
export default function OrganizationInformationCreateForm(props: OrganizationInformationCreateFormProps): React.ReactElement;
