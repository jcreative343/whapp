...
export declare type GeneralInformationUpdateFormInputValues = {
    userId?: string;
    FirstName?: string;
    LastName?: string;
    Email?: string;
...
export declare type GeneralInformationUpdateFormValidationValues = {
...
export declare type GeneralInformationUpdateFormOverridesProps = {
    GeneralInformationUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type GeneralInformationUpdateFormProps = React.PropsWithChildren<{
    overrides?: GeneralInformationUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    generalInformation?: any;
    onSubmit?: (fields: GeneralInformationUpdateFormInputValues) => GeneralInformationUpdateFormInputValues;
    onSuccess?: (fields: GeneralInformationUpdateFormInputValues) => void;
    onError?: (fields: GeneralInformationUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: GeneralInformationUpdateFormInputValues) => GeneralInformationUpdateFormInputValues;
    onValidate?: GeneralInformationUpdateFormValidationValues;
} & React.CSSProperties>;
export default function GeneralInformationUpdateForm(props: GeneralInformationUpdateFormProps): React.ReactElement;
