...
export declare type TrackPlanCreateFormInputValues = {
    userId?: string;
...
export declare type TrackPlanCreateFormValidationValues = {
...
export declare type TrackPlanCreateFormOverridesProps = {
    TrackPlanCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type TrackPlanCreateFormProps = React.PropsWithChildren<{
    overrides?: TrackPlanCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: TrackPlanCreateFormInputValues) => TrackPlanCreateFormInputValues;
    onSuccess?: (fields: TrackPlanCreateFormInputValues) => void;
    onError?: (fields: TrackPlanCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: TrackPlanCreateFormInputValues) => TrackPlanCreateFormInputValues;
    onValidate?: TrackPlanCreateFormValidationValues;
} & React.CSSProperties>;
export default function TrackPlanCreateForm(props: TrackPlanCreateFormProps): React.ReactElement;
