...
import { getAssessmentScores } from "../graphql/queries";
import { updateAssessmentScores } from "../graphql/mutations";
const client = generateClient();
export default function AssessmentScoresUpdateForm(props) {
  const {
    id: idProp,
    assessmentScores: assessmentScoresModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [CMScore, setCMScore] = React.useState(initialValues.CMScore);
  const [MHScore, setMHScore] = React.useState(initialValues.MHScore);
  const [PHScore, setPHScore] = React.useState(initialValues.PHScore);
  const [SHScore, setSHScore] = React.useState(initialValues.SHScore);
  const [OLScore, setOLScore] = React.useState(initialValues.OLScore);
  ...
  const resetStateValues = () => {
    const cleanValues = assessmentScoresRecord
      ? { ...initialValues, ...assessmentScoresRecord }
      : initialValues;
    setUserId(cleanValues.userId);
    setCompletedDate(cleanValues.CompletedDate);
    setCompletedTime(cleanValues.CompletedTime);
    setTRHurtfulNames(cleanValues.TRHurtfulNames);
    setTRNoNurturing(cleanValues.TRNoNurturing);
    setTRHit(cleanValues.TRHit);
    setTRNeedsNotMet(cleanValues.TRNeedsNotMet);
    setTRForcedSex(cleanValues.TRForcedSex);
    setTRResponsible(cleanValues.TRResponsible);
    setTRViolence(cleanValues.TRViolence);
    setTRSubstanceAbuse(cleanValues.TRSubstanceAbuse);
    setTRMentalIllness(cleanValues.TRMentalIllness);
    setTRParentDivorce(cleanValues.TRParentDivorce);
    setTRParentIncarcerated(cleanValues.TRParentIncarcerated);
    setTRHomelessness(cleanValues.TRHomelessness);
    setTRBodyFunction(cleanValues.TRBodyFunction);
    setTRNaturalDisaster(cleanValues.TRNaturalDisaster);
    setTRDirectTerrorism(cleanValues.TRDirectTerrorism);
    setTRIndirectTerrorism(cleanValues.TRIndirectTerrorism);
    setTRLovedOne(cleanValues.TRLovedOne);
    setTRBelief(cleanValues.TRBelief);
    setTRResponseProfessional(cleanValues.TRResponseProfessional);
    setTRResponseFamilyFriend(cleanValues.TRResponseFamilyFriend);
    setTRResponseGod(cleanValues.TRResponseGod);
    setTRResponseNoOne(cleanValues.TRResponseNoOne);
    setTRNoTrauma(cleanValues.TRNoTrauma);
    setCMAlcohol(cleanValues.CMAlcohol);
    setCMDrugs(cleanValues.CMDrugs);
    setCMOvereating(cleanValues.CMOvereating);
    setCMSmoking(cleanValues.CMSmoking);
    setCMGaming(cleanValues.CMGaming);
    setCMShopping(cleanValues.CMShopping);
    setCMGambling(cleanValues.CMGambling);
    setCMSex(cleanValues.CMSex);
    setCMPorn(cleanValues.CMPorn);
    setCMBlaming(cleanValues.CMBlaming);
    setCMHurting(cleanValues.CMHurting);
    setCMDisengage(cleanValues.CMDisengage);
    setCMArt(cleanValues.CMArt);
    setCMMusic(cleanValues.CMMusic);
    setCMPoetry(cleanValues.CMPoetry);
    setCMReading(cleanValues.CMReading);
    setCMGroups(cleanValues.CMGroups);
    setCMCounseling(cleanValues.CMCounseling);
    setCMVenting(cleanValues.CMVenting);
    setCMWriting(cleanValues.CMWriting);
    setCMSensory(cleanValues.CMSensory);
    setCMDancing(cleanValues.CMDancing);
    setCMExercising(cleanValues.CMExercising);
    setCMWalking(cleanValues.CMWalking);
    setCMChange(cleanValues.CMChange);
    setCMAnalyze(cleanValues.CMAnalyze);
    setCMDaydream(cleanValues.CMDaydream);
    setCMPositive(cleanValues.CMPositive);
    setMHDxPTSD(cleanValues.MHDxPTSD);
    setMHDxDepression(cleanValues.MHDxDepression);
    setMHDxSUD(cleanValues.MHDxSUD);
    setMHDxOtherMental(cleanValues.MHDxOtherMental);
    setMHSleeplessness(cleanValues.MHSleeplessness);
    setMHAlcoholUse(cleanValues.MHAlcoholUse);
    setMHAnxiety(cleanValues.MHAnxiety);
    setMHDepression(cleanValues.MHDepression);
    setMHDrugUse(cleanValues.MHDrugUse);
    setMHGrief(cleanValues.MHGrief);
    setMHGuilt(cleanValues.MHGuilt);
    setMHIrritability(cleanValues.MHIrritability);
    setMHStress(cleanValues.MHStress);
    setMHRegret(cleanValues.MHRegret);
    setMHSuicidalThoughts(cleanValues.MHSuicidalThoughts);
    setMHLoneliness(cleanValues.MHLoneliness);
    setMHWorry(cleanValues.MHWorry);
    setPHDxInfertility(cleanValues.PHDxInfertility);
    setPHDxCurableSTD(cleanValues.PHDxCurableSTD);
    setPHDxIncurableSTD(cleanValues.PHDxIncurableSTD);
    setPHDxCancer(cleanValues.PHDxCancer);
    setPHDxDiabetes(cleanValues.PHDxDiabetes);
    setPHDxHighBlood(cleanValues.PHDxHighBlood);
    setPHDxHeartDisease(cleanValues.PHDxHeartDisease);
    setPHDxIrritableBowel(cleanValues.PHDxIrritableBowel);
    setPHDxVitA(cleanValues.PHDxVitA);
    setPHDxVitB(cleanValues.PHDxVitB);
    setPHDxVitC(cleanValues.PHDxVitC);
    setPHDxVitD(cleanValues.PHDxVitD);
    setPHDxVitE(cleanValues.PHDxVitE);
    setPHDxVitK(cleanValues.PHDxVitK);
    setPHDxAutoimmune(cleanValues.PHDxAutoimmune);
    setPHDxOtherPhysical(cleanValues.PHDxOtherPhysical);
    setPHVegeFruits(cleanValues.PHVegeFruits);
    setPHBeanLentils(cleanValues.PHBeanLentils);
    setPHGrainBreads(cleanValues.PHGrainBreads);
    setPHDairy(cleanValues.PHDairy);
    setPHMeat(cleanValues.PHMeat);
    setPHFishSeafood(cleanValues.PHFishSeafood);
    setPHSweets(cleanValues.PHSweets);
    setPHWater(cleanValues.PHWater);
    setPHPhysicalActivity(cleanValues.PHPhysicalActivity);
    setSHSpiritualDefine(cleanValues.SHSpiritualDefine);
    setSHSpiritualIntegrate(cleanValues.SHSpiritualIntegrate);
    setSHPrayer(cleanValues.SHPrayer);
    setSHSpiritualActivity(cleanValues.SHSpiritualActivity);
    setSHReadText(cleanValues.SHReadText);
    setSHAlignText(cleanValues.SHAlignText);
    setSHCommunity(cleanValues.SHCommunity);
    setOLHope(cleanValues.OLHope);
    setOLPeace(cleanValues.OLPeace);
    setOLLearning(cleanValues.OLLearning);
    setOLJoy(cleanValues.OLJoy);
    setOLStable(cleanValues.OLStable);
    setOLSafety(cleanValues.OLSafety);
    setOLKindness(cleanValues.OLKindness);
    setOLForgiveness(cleanValues.OLForgiveness);
    setOLPatience(cleanValues.OLPatience);
    setOLRelationships(cleanValues.OLRelationships);
    setOLBoundaries(cleanValues.OLBoundaries);
    setOLEUnpleasant(cleanValues.OLEUnpleasant);
    setOLEPleasant(cleanValues.OLEPleasant);
    setOLEControl(cleanValues.OLEControl);
    setOLENumber(cleanValues.OLENumber);
    setSDoHAgeRange(cleanValues.SDoHAgeRange);
    setSDoHRace(cleanValues.SDoHRace);
    setSDoHGeographicRegion(cleanValues.SDoHGeographicRegion);
    setSDoHEthnicity(cleanValues.SDoHEthnicity);
    setSDoHState(cleanValues.SDoHState);
    setSDoHZipCode(cleanValues.SDoHZipCode);
    setSDoHMaritalStatus(cleanValues.SDoHMaritalStatus);
    setSDoHMilitaryStatus(cleanValues.SDoHMilitaryStatus);
    setSDoHGender(cleanValues.SDoHGender);
    setSDoHEducation(cleanValues.SDoHEducation);
    setSDoHJobStatus(cleanValues.SDoHJobStatus);
    setSDoHIncome(cleanValues.SDoHIncome);
    setSDoHHousingStatus(cleanValues.SDoHHousingStatus);
    setSDoHHomeAsChild(cleanValues.SDoHHomeAsChild);
    setSDoHReligion(cleanValues.SDoHReligion);
    setSDoHDenomination(cleanValues.SDoHDenomination);
    setTRScore(cleanValues.TRScore);
    setCMScore(cleanValues.CMScore);
    setMHScore(cleanValues.MHScore);
    setPHScore(cleanValues.PHScore);
    setSHScore(cleanValues.SHScore);
    setOLScore(cleanValues.OLScore);
    setIsActive(cleanValues.isActive);
    setSHSkip(cleanValues.SHSkip);
    setProAssessmentFinalizedReview1(cleanValues.ProAssessmentFinalizedReview1);
    setProAssessmentFinalizedReviewDate1(
      cleanValues.ProAssessmentFinalizedReviewDate1
    );
    setProAssessmentFinalizedName1(cleanValues.ProAssessmentFinalizedName1);
    setProAssessmentFinalizedRole1(cleanValues.ProAssessmentFinalizedRole1);
    setProAssessmentFinalizedReview2(cleanValues.ProAssessmentFinalizedReview2);
    setProAssessmentFinalizedReviewDate2(
      cleanValues.ProAssessmentFinalizedReviewDate2
    );
    setProAssessmentFinalizedName2(cleanValues.ProAssessmentFinalizedName2);
    setProAssessmentFinalizedRole2(cleanValues.ProAssessmentFinalizedRole2);
    setProAssessmentFinalizedReview3(cleanValues.ProAssessmentFinalizedReview3);
    setProAssessmentFinalizedReviewDate3(
      cleanValues.ProAssessmentFinalizedReviewDate3
    );
    setProAssessmentFinalizedName3(cleanValues.ProAssessmentFinalizedName3);
    setProAssessmentFinalizedRole3(cleanValues.ProAssessmentFinalizedRole3);
    setErrors({});
  };
  const [assessmentScoresRecord, setAssessmentScoresRecord] = React.useState(
    assessmentScoresModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getAssessmentScores.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getAssessmentScores
        : assessmentScoresModelProp;
      setAssessmentScoresRecord(record);
    };
    queryData();
  }, [idProp, assessmentScoresModelProp]);
  React.useEffect(resetStateValues, [assessmentScoresRecord]);
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          TRHurtfulNames: TRHurtfulNames ?? null,
          TRNoNurturing: TRNoNurturing ?? null,
          TRHit: TRHit ?? null,
          TRNeedsNotMet: TRNeedsNotMet ?? null,
          TRForcedSex: TRForcedSex ?? null,
          TRResponsible: TRResponsible ?? null,
          TRViolence: TRViolence ?? null,
          TRSubstanceAbuse: TRSubstanceAbuse ?? null,
          TRMentalIllness: TRMentalIllness ?? null,
          TRParentDivorce: TRParentDivorce ?? null,
          TRParentIncarcerated: TRParentIncarcerated ?? null,
          TRHomelessness: TRHomelessness ?? null,
          TRBodyFunction: TRBodyFunction ?? null,
          TRNaturalDisaster: TRNaturalDisaster ?? null,
          TRDirectTerrorism: TRDirectTerrorism ?? null,
          TRIndirectTerrorism: TRIndirectTerrorism ?? null,
          TRLovedOne: TRLovedOne ?? null,
          TRBelief: TRBelief ?? null,
          TRResponseProfessional: TRResponseProfessional ?? null,
          TRResponseFamilyFriend: TRResponseFamilyFriend ?? null,
          TRResponseGod: TRResponseGod ?? null,
          TRResponseNoOne: TRResponseNoOne ?? null,
          TRNoTrauma: TRNoTrauma ?? null,
          CMAlcohol: CMAlcohol ?? null,
          CMDrugs: CMDrugs ?? null,
          CMOvereating: CMOvereating ?? null,
          CMSmoking: CMSmoking ?? null,
          CMGaming: CMGaming ?? null,
          CMShopping: CMShopping ?? null,
          CMGambling: CMGambling ?? null,
          CMSex: CMSex ?? null,
          CMPorn: CMPorn ?? null,
          CMBlaming: CMBlaming ?? null,
          CMHurting: CMHurting ?? null,
          CMDisengage: CMDisengage ?? null,
          CMArt: CMArt ?? null,
          CMMusic: CMMusic ?? null,
          CMPoetry: CMPoetry ?? null,
          CMReading: CMReading ?? null,
          CMGroups: CMGroups ?? null,
          CMCounseling: CMCounseling ?? null,
          CMVenting: CMVenting ?? null,
          CMWriting: CMWriting ?? null,
          CMSensory: CMSensory ?? null,
          CMDancing: CMDancing ?? null,
          CMExercising: CMExercising ?? null,
          CMWalking: CMWalking ?? null,
          CMChange: CMChange ?? null,
          CMAnalyze: CMAnalyze ?? null,
          CMDaydream: CMDaydream ?? null,
          CMPositive: CMPositive ?? null,
          MHDxPTSD: MHDxPTSD ?? null,
          MHDxDepression: MHDxDepression ?? null,
          MHDxSUD: MHDxSUD ?? null,
          MHDxOtherMental: MHDxOtherMental ?? null,
          MHSleeplessness: MHSleeplessness ?? null,
          MHAlcoholUse: MHAlcoholUse ?? null,
          MHAnxiety: MHAnxiety ?? null,
          MHDepression: MHDepression ?? null,
          MHDrugUse: MHDrugUse ?? null,
          MHGrief: MHGrief ?? null,
          MHGuilt: MHGuilt ?? null,
          MHIrritability: MHIrritability ?? null,
          MHStress: MHStress ?? null,
          MHRegret: MHRegret ?? null,
          MHSuicidalThoughts: MHSuicidalThoughts ?? null,
          MHLoneliness: MHLoneliness ?? null,
          MHWorry: MHWorry ?? null,
          PHDxInfertility: PHDxInfertility ?? null,
          PHDxCurableSTD: PHDxCurableSTD ?? null,
          PHDxIncurableSTD: PHDxIncurableSTD ?? null,
          PHDxCancer: PHDxCancer ?? null,
          PHDxDiabetes: PHDxDiabetes ?? null,
          PHDxHighBlood: PHDxHighBlood ?? null,
          PHDxHeartDisease: PHDxHeartDisease ?? null,
          PHDxIrritableBowel: PHDxIrritableBowel ?? null,
          PHDxVitA: PHDxVitA ?? null,
          PHDxVitB: PHDxVitB ?? null,
          PHDxVitC: PHDxVitC ?? null,
          PHDxVitD: PHDxVitD ?? null,
          PHDxVitE: PHDxVitE ?? null,
          PHDxVitK: PHDxVitK ?? null,
          PHDxAutoimmune: PHDxAutoimmune ?? null,
          PHDxOtherPhysical: PHDxOtherPhysical ?? null,
          PHVegeFruits: PHVegeFruits ?? null,
          PHBeanLentils: PHBeanLentils ?? null,
          PHGrainBreads: PHGrainBreads ?? null,
          PHDairy: PHDairy ?? null,
          PHMeat: PHMeat ?? null,
          PHFishSeafood: PHFishSeafood ?? null,
          PHSweets: PHSweets ?? null,
          PHWater: PHWater ?? null,
          PHPhysicalActivity: PHPhysicalActivity ?? null,
          SHSpiritualDefine: SHSpiritualDefine ?? null,
          SHSpiritualIntegrate: SHSpiritualIntegrate ?? null,
          SHPrayer: SHPrayer ?? null,
          SHSpiritualActivity: SHSpiritualActivity ?? null,
          SHReadText: SHReadText ?? null,
          SHAlignText: SHAlignText ?? null,
          SHCommunity: SHCommunity ?? null,
          OLHope: OLHope ?? null,
          OLPeace: OLPeace ?? null,
          OLLearning: OLLearning ?? null,
          OLJoy: OLJoy ?? null,
          OLStable: OLStable ?? null,
          OLSafety: OLSafety ?? null,
          OLKindness: OLKindness ?? null,
          OLForgiveness: OLForgiveness ?? null,
          OLPatience: OLPatience ?? null,
          OLRelationships: OLRelationships ?? null,
          OLBoundaries: OLBoundaries ?? null,
          OLEUnpleasant: OLEUnpleasant ?? null,
          OLEPleasant: OLEPleasant ?? null,
          OLEControl: OLEControl ?? null,
          OLENumber: OLENumber ?? null,
          SDoHAgeRange: SDoHAgeRange ?? null,
          SDoHRace: SDoHRace ?? null,
          SDoHGeographicRegion: SDoHGeographicRegion ?? null,
          SDoHEthnicity: SDoHEthnicity ?? null,
          SDoHState: SDoHState ?? null,
          SDoHZipCode: SDoHZipCode ?? null,
          SDoHMaritalStatus: SDoHMaritalStatus ?? null,
          SDoHMilitaryStatus: SDoHMilitaryStatus ?? null,
          SDoHGender: SDoHGender ?? null,
          SDoHEducation: SDoHEducation ?? null,
          SDoHJobStatus: SDoHJobStatus ?? null,
          SDoHIncome: SDoHIncome ?? null,
          SDoHHousingStatus: SDoHHousingStatus ?? null,
          SDoHHomeAsChild: SDoHHomeAsChild ?? null,
          SDoHReligion: SDoHReligion ?? null,
          SDoHDenomination: SDoHDenomination ?? null,
          TRScore: TRScore ?? null,
          CMScore: CMScore ?? null,
          MHScore: MHScore ?? null,
          PHScore: PHScore ?? null,
          SHScore: SHScore ?? null,
          OLScore: OLScore ?? null,
          isActive,
          SHSkip: SHSkip ?? null,
          ProAssessmentFinalizedReview1: ProAssessmentFinalizedReview1 ?? null,
          ProAssessmentFinalizedReviewDate1:
            ProAssessmentFinalizedReviewDate1 ?? null,
          ProAssessmentFinalizedName1: ProAssessmentFinalizedName1 ?? null,
          ProAssessmentFinalizedRole1: ProAssessmentFinalizedRole1 ?? null,
          ProAssessmentFinalizedReview2: ProAssessmentFinalizedReview2 ?? null,
          ProAssessmentFinalizedReviewDate2:
            ProAssessmentFinalizedReviewDate2 ?? null,
          ProAssessmentFinalizedName2: ProAssessmentFinalizedName2 ?? null,
          ProAssessmentFinalizedRole2: ProAssessmentFinalizedRole2 ?? null,
          ProAssessmentFinalizedReview3: ProAssessmentFinalizedReview3 ?? null,
          ProAssessmentFinalizedReviewDate3:
            ProAssessmentFinalizedReviewDate3 ?? null,
          ProAssessmentFinalizedName3: ProAssessmentFinalizedName3 ?? null,
          ProAssessmentFinalizedRole3: ProAssessmentFinalizedRole3 ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateAssessmentScores.replaceAll("__typename", ""),
            variables: {
              input: {
                id: assessmentScoresRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "AssessmentScoresUpdateForm")}
      {...rest}
    >
      <TextField
        label="User id"
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.CMScore ?? value;
          }
          if (errors.CMScore?.hasError) {
            runValidationTasks("CMScore", value);
          }
          setCMScore(value);
        }}
        onBlur={() => runValidationTasks("CMScore", CMScore)}
        errorMessage={errors.CMScore?.errorMessage}
        hasError={errors.CMScore?.hasError}
        {...getOverrideProps(overrides, "CMScore")}
      ></TextField>
      <TextField
        label="Mh score"
        isRequired={false}
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.MHScore ?? value;
          }
          if (errors.MHScore?.hasError) {
            runValidationTasks("MHScore", value);
          }
          setMHScore(value);
        }}
        onBlur={() => runValidationTasks("MHScore", MHScore)}
        errorMessage={errors.MHScore?.errorMessage}
        hasError={errors.MHScore?.hasError}
        {...getOverrideProps(overrides, "MHScore")}
      ></TextField>
      <TextField
        label="Ph score"
        isRequired={false}
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.PHScore ?? value;
          }
          if (errors.PHScore?.hasError) {
            runValidationTasks("PHScore", value);
          }
          setPHScore(value);
        }}
        onBlur={() => runValidationTasks("PHScore", PHScore)}
        errorMessage={errors.PHScore?.errorMessage}
        hasError={errors.PHScore?.hasError}
        {...getOverrideProps(overrides, "PHScore")}
      ></TextField>
      <TextField
        label="Sh score"
        isRequired={false}
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.SHScore ?? value;
          }
          if (errors.SHScore?.hasError) {
            runValidationTasks("SHScore", value);
          }
          setSHScore(value);
        }}
        onBlur={() => runValidationTasks("SHScore", SHScore)}
        errorMessage={errors.SHScore?.errorMessage}
        hasError={errors.SHScore?.hasError}
        {...getOverrideProps(overrides, "SHScore")}
      ></TextField>
      <TextField
        label="Ol score"
        isRequired={false}
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.OLScore ?? value;
          }
          if (errors.OLScore?.hasError) {
            runValidationTasks("OLScore", value);
          }
          setOLScore(value);
        }}
        onBlur={() => runValidationTasks("OLScore", OLScore)}
        errorMessage={errors.OLScore?.errorMessage}
        hasError={errors.OLScore?.hasError}
        {...getOverrideProps(overrides, "OLScore")}
      ></TextField>
      <SwitchField
        label="Is active"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || assessmentScoresModelProp)}
