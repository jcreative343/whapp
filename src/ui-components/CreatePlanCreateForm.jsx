...
import { createCreatePlan } from "../graphql/mutations";
const client = generateClient();
export default function CreatePlanCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPSProblemSolving(initialValues.PSProblemSolving);
    setPSSelfEsteem(initialValues.PSSelfEsteem);
    setPSChoiceAutonomy(initialValues.PSChoiceAutonomy);
    setPSSelfCare(initialValues.PSSelfCare);
    setPSSelfAwareness(initialValues.PSSelfAwareness);
    setPSCreativity(initialValues.PSCreativity);
    setCSForgiveness(initialValues.CSForgiveness);
    setCSKindness(initialValues.CSKindness);
    setCSGratitude(initialValues.CSGratitude);
    setCSPatience(initialValues.CSPatience);
    setCSCourage(initialValues.CSCourage);
    setCMSCopingChoice(initialValues.CMSCopingChoice);
    setCMSResilience(initialValues.CMSResilience);
    setCMSSelfRegulation(initialValues.CMSSelfRegulation);
    setCMSOptimism(initialValues.CMSOptimism);
    setCOMSupportSystem(initialValues.COMSupportSystem);
    setCOMSocialIntelligence(initialValues.COMSocialIntelligence);
    setCOMCommunication(initialValues.COMCommunication);
    setCOMFaithCommunity(initialValues.COMFaithCommunity);
    setCOMAccomplishments(initialValues.COMAccomplishments);
    setBRStableHousing(initialValues.BRStableHousing);
    setBRQualityHealthcare(initialValues.BRQualityHealthcare);
    setBRProfessionalAccess(initialValues.BRProfessionalAccess);
    setBRInsuranceCoverage(initialValues.BRInsuranceCoverage);
    setBRFinancialConstraints(initialValues.BRFinancialConstraints);
    setBREducationAttainment(initialValues.BREducationAttainment);
    setBRSocialStigma(initialValues.BRSocialStigma);
    setBRUnsupportiveCommunity(initialValues.BRUnsupportiveCommunity);
    setBRNonexistentCommunity(initialValues.BRNonexistentCommunity);
    setBRCommunityResources(initialValues.BRCommunityResources);
    setBRProfessionalTrust(initialValues.BRProfessionalTrust);
    setBRHealthcareSystemTrust(initialValues.BRHealthcareSystemTrust);
    setBRCognitiveImpairments(initialValues.BRCognitiveImpairments);
    setBRDependentCare(initialValues.BRDependentCare);
    setBRTransportation(initialValues.BRTransportation);
    setBRTechnologyAccess(initialValues.BRTechnologyAccess);
    setBRLanguage(initialValues.BRLanguage);
    setBRHealthcareProcess(initialValues.BRHealthcareProcess);
    setBROther(initialValues.BROther);
    setBRResponseNote(initialValues.BRResponseNote);
    setTGBetrayal(initialValues.TGBetrayal);
    setTGBoundaries(initialValues.TGBoundaries);
    setTGDisorder(initialValues.TGDisorder);
    setTGPain(initialValues.TGPain);
    setTGRejection(initialValues.TGRejection);
    setTGStress(initialValues.TGStress);
    setTGMemories(initialValues.TGMemories);
    setTGUnjustTreatment(initialValues.TGUnjustTreatment);
    setTGUnpleasantConversations(initialValues.TGUnpleasantConversations);
    setTGUnsafeEnvironments(initialValues.TGUnsafeEnvironments);
    setTGOther(initialValues.TGOther);
    setWSFlashbacks(initialValues.WSFlashbacks);
    setWSIncreasedAppetite(initialValues.WSIncreasedAppetite);
    setWSDecreasedAppetite(initialValues.WSDecreasedAppetite);
    setWSIntenseEmotions(initialValues.WSIntenseEmotions);
    setWSDisconnecting(initialValues.WSDisconnecting);
    setWSTime(initialValues.WSTime);
    setWSNegativeSelfTalk(initialValues.WSNegativeSelfTalk);
    setWSNeglectingSelfCare(initialValues.WSNeglectingSelfCare);
    setWSNightmares(initialValues.WSNightmares);
    setWSRecklessBehavior(initialValues.WSRecklessBehavior);
    setWSOther(initialValues.WSOther);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCreatePlan.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CreatePlanCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
