...
import { createAssessmentScores } from "../graphql/mutations";
const client = generateClient();
export default function AssessmentScoresCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCMScore(initialValues.CMScore);
    setMHScore(initialValues.MHScore);
    setPHScore(initialValues.PHScore);
    setSHScore(initialValues.SHScore);
    setOLScore(initialValues.OLScore);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAssessmentScores.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AssessmentScoresCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
