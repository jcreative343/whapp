...
export default function NotificationsCreateForm(props) {
  ...
  const resetStateValues = () => {
    setRecommedationResult(initialValues.RecommedationResult);
    setRecommedationAction(initialValues.RecommedationAction);
    setRecommedationActionFrequency(initialValues.RecommedationActionFrequency);
    setRecommedationType(initialValues.RecommedationType);
    setRecommedationNote(initialValues.RecommedationNote);
    setRecommendationDate(initialValues.RecommendationDate);
    setSenderId(initialValues.SenderId);
    setSenderFirstName(initialValues.SenderFirstName);
    setSenderLastName(initialValues.SenderLastName);
    ...
    setStatusDate(initialValues.StatusDate);
