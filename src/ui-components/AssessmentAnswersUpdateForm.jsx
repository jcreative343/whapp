...
import { getAssessmentAnswers } from "../graphql/queries";
import { updateAssessmentAnswers } from "../graphql/mutations";
const client = generateClient();
export default function AssessmentAnswersUpdateForm(props) {
  const {
    id: idProp,
    assessmentAnswers: assessmentAnswersModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = assessmentAnswersRecord
      ? { ...initialValues, ...assessmentAnswersRecord }
      : initialValues;
  ...
  const [assessmentAnswersRecord, setAssessmentAnswersRecord] = React.useState(
    assessmentAnswersModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getAssessmentAnswers.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getAssessmentAnswers
        : assessmentAnswersModelProp;
      setAssessmentAnswersRecord(record);
    };
    queryData();
  }, [idProp, assessmentAnswersModelProp]);
  React.useEffect(resetStateValues, [assessmentAnswersRecord]);
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateAssessmentAnswers.replaceAll("__typename", ""),
            variables: {
              input: {
                id: assessmentAnswersRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "AssessmentAnswersUpdateForm")}
      {...rest}
    >
      <TextField
        label="User id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || assessmentAnswersModelProp)}
